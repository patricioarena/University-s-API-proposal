...
module.exports = {
  ...
  adminAuth: {
    ...
    users: [
      {
        username: "admin",
        password: "$2a$08$8cwy0fWGkOLBxg7TuQmCFOnSTkwkInD10JxKPbh.vGwZoOnqvPAsi",
        // call npm run adminauth -- mypassword to generate a password
        // for further information see http://nodered.org/docs/security.html#generating-the-password-hash
        // or use =>[ node -e "console.log(require('bcryptjs').hashSync(process.argv[1], 8));" your-password-here ]
